...
public class Main {
    ...
    static class Marble {
        ...
        public Marble(int r, int c, int count, String path) {
            this.r = r;
            this.c = c;
            this.count = count;
            this.path = path;
    ...
    private static Marble bfs() {
        ...
        while (!que.isEmpty()) {
            ...
            for (int d = 0; d < 4; d++) {
                ...
                boolean fail = false;
                Marble currRed = new Marble(red.r, red.c, red.count,red.path);
                Marble currBlue = new Marble(blue.r, blue.c, blue.count,blue.path);
                while (!isWallRed) {
                    Marble nextRed = new Marble(currRed.r + dr[d], currRed.c + dc[d], currRed.count,currRed.path);
                ...
                currRed.count++;
                currRed.path+=select[d];
                if(currRed.count>10) {
                    return new Marble(0,0,-1);
                }
                ...
                if(fail){
                    ...
                    que.offer(new Marble[]{new Marble(currRed.r,currRed.c,currRed.count,currRed.path),new Marble(currBlue.r,currBlue.c)});
